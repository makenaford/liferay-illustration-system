...
/**
 * The nine ported illustrations, loaded as the editor's fixture set. Building
 * against real documents rather than a hello-world is what surfaced the
 * bounds and z-order requirements.
 */
export const DOCS = [
  deployDaily,
  driveConversions,
